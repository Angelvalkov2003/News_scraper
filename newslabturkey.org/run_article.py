...
class NewslabturkeyRunner(BaseRunner):
    def __init__(self):
    ...
    def get_description(self) -> str:
        return "Fetch NewsLabTurkey article by URL; with --parse run parser to JSON, with --ai generate JSON via API."

    def get_url_help(self) -> str:
        return "Full article URL (e.g. https://www.newslabturkey.org/2026/01/26/article-slug/)"


if __name__ == "__main__":
    NewslabturkeyRunner().main()
