...
class SporxRunner(BaseRunner):
    ...
    def get_description(self) -> str:
        return "Fetch Sporx article by URL; with --parse run parser to JSON, with --ai generate JSON via API."

    def get_url_help(self) -> str:
        return "Full article URL (e.g. https://www.sporx.com/marcus-rashford-atletico-madrid-macinda-yok-SXHBQ1150943SXQ)"
