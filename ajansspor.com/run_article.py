...
class AjanssporRunner(BaseRunner):
    def __init__(self):
    ...
    def get_description(self) -> str:
        return "Fetch Ajansspor article by URL; with --parse run parser to JSON, with --ai generate JSON via API."

    def get_url_help(self) -> str:
        return "Full article URL (e.g. https://ajansspor.com/haber/...-718480)"


if __name__ == "__main__":
    AjanssporRunner().main()
