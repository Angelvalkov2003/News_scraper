...
class IklimhaberRunner(BaseRunner):
    def __init__(self):
    ...
    def get_description(self) -> str:
        return "Fetch İklim Haber article by URL; with --parse run parser to JSON, with --ai generate JSON via API."

    def get_url_help(self) -> str:
        return "Full article URL (e.g. https://www.iklimhaber.org/yeni-rapor-sirketler-ya-dogayi-koruyacak-ya-da-yok-olma-riskiyle-karsi-karsiya-kalacak/)"


if __name__ == "__main__":
    IklimhaberRunner().main()
