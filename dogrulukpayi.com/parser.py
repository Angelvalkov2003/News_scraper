"""Парсва HTML -> scraped_article_json_schema.json в Parsed_files/. TODO: имплементирай за dogrulukpayi.com."""
...
def parse_article_html(html_raw: bytes, base_url: str = "https://www.dogrulukpayi.com") -> dict:
