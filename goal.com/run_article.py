...
class GoalRunner(BaseRunner):
    ...
    def get_description(self) -> str:
        return "Fetch Goal.com (tr) article by URL; with --parse run parser to JSON, with --ai generate JSON via API."

    def get_url_help(self) -> str:
        return "Full article URL (e.g. https://www.goal.com/tr/haber/.../blt4dbbfaa571259166)"
